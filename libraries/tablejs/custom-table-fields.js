...
var customtablefields = {
  ...
  'group-processlist': {
    ...
    'date': {
        'draw': function (t,row,child_row,field) {
            var date = new Date();
            date.setTime(1000 * t.data[row][field]); //segundos a milisegundos
        ...
        'edit':function (t,row,child_row,field) {
            ...
            var month = date.getMonth() +1; // getMonth() retorna 0-11
...
function relative_time(time) {
  ...
  else if (secs < 0) relative_time = secs.toFixed(0) + "s"; // Actualiza el tiempo
...
// Formatear el valor dinamicamente
