...
<script type="text/javascript"><?php require "Ext_Modules/process/process_langjs.php"; ?></script>
<script type="text/javascript" src="<?php echo $path; ?>Ext_Modules/process/Views/process_ui.js?v=<?php echo $v; ?>"></script>
