...
global $path; $v=3;
?>
<link href="<?php echo $path; ?>Ext_Modules/user/profile/profile.css?v=<?php echo $v; ?>" rel="stylesheet">
<script type="text/javascript" src="<?php echo $path; ?>Ext_Modules/user/profile/md5.js?v=<?php echo $v; ?>"></script>
<script type="text/javascript" src="<?php echo $path; ?>Libraries/misc/qrcode.js?v=<?php echo $v; ?>"></script>
<script type="text/javascript" src="<?php echo $path; ?>Libraries/misc/clipboard.js?v=<?php echo $v; ?>"></script>
<script type="text/javascript" src="<?php echo $path; ?>Ext_Modules/user/user.js?v=<?php echo $v; ?>"></script>
...
<div style="background-color:#f0f0f0; padding:20px; max-width:360px">
  ...
  <a href="https://play.google.com/store/apps/details?id=org.emoncms.myapps"><img alt="Get it on Google Play" src="<?php echo $path; ?>Ext_Modules/user/images/en-play-badge.png" /></a>
  <a href="https://itunes.apple.com/us/app/emoncms/id1169483587?ls=1&mt=8"><img alt="Download on the App Store" src="<?php echo $path; ?>Ext_Modules/user/images/appstore.png" /></a>
  </div>
</div>
</div>
...
<script type="text/javascript" src="<?php echo $path; ?>Ext_Modules/user/profile/profile.js?v=<?php echo $v; ?>"></script>
