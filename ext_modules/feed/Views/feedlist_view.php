...
<script type="text/javascript" src="<?php echo $path; ?>Ext_Modules/user/user.js"></script>

<script src="<?php echo $path; ?>Libraries/moment.min.js"></script>
<script>
    var _user = {};
    _user.lang = "<?php echo $_SESSION['lang']; ?>";
</script>
<script src="<?php echo $path; ?>Libraries/user_locale.js?v=<?php echo $v; ?>"></script>
<script>
...
<script type="text/javascript" src="<?php echo $path; ?>Ext_Modules/feed/feed.js?v=<?php echo $v; ?>"></script>
<script type="text/javascript" src="<?php echo $path; ?>Libraries/responsive-linked-tables.js?v=<?php echo $v; ?>"></script>

<link href="<?php echo $path; ?>Libraries/bootstrap-datetimepicker-0.0.11/css/bootstrap-datetimepicker.min.css" rel="stylesheet">
<script src="<?php echo $path; ?>Libraries/bootstrap-datetimepicker-0.0.11/js/bootstrap-datetimepicker.min.js"></script>

<script type="text/javascript" src="<?php echo $path; ?>Libraries/misc/autocomplete.js?v=<?php echo $v; ?>"></script>
<link rel="stylesheet" href="<?php echo $path; ?>Libraries/misc/autocomplete.css?v=<?php echo $v; ?>">
...
<?php require "Ext_Modules/feed/Views/exporter.php"; ?>
...
<?php require "Ext_Modules/feed/Views/importer.php"; ?>
<?php require "Ext_Modules/process/Views/process_ui.php"; ?>
<!------------------------------------------------------------------------------------------------------------------------------------------------- -->
<script>
...
<script type="text/javascript" src="<?php echo $path; ?>Ext_Modules/feed/Views/exporter.js"></script>
<script type="text/javascript" src="<?php echo $path; ?>Ext_Modules/feed/Views/importer.js?v=2"></script>
