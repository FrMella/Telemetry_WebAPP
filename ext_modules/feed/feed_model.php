...
class Feed
{
        ...
        if (isset($engines[$e])) {
            ...
            switch ($e) {
                case (string)Engine::MYSQL :
                    require "Ext_Modules/feed/engine/MysqlTimeSeries.php";  // Mysql engine
                    $engines[$e] = new MysqlTimeSeries($this->mysqli,$this->redis,$this->settings['mysqltimeseries']);
                    break;
                case (string)Engine::VIRTUALFEED :
                    require "Ext_Modules/feed/engine/VirtualFeed.php";      // Takes care of Virtual Feeds
                    $engines[$e] =  new VirtualFeed($this->mysqli,$this->redis,$this);
                    break;
                case (string)Engine::PHPFINA :
                    require "Ext_Modules/feed/engine/PHPFina.php";          // Fixed interval no averaging
                    $engines[$e] =  new PHPFina($this->settings['phpfina']);
                    break;
                case (string)Engine::REDISBUFFER :
                    require "Ext_Modules/feed/engine/RedisBuffer.php";      // Redis buffer for low-write mode
                    $engines[$e] = new RedisBuffer($this->redis,$this->settings['redisbuffer'],$this);
                    break;
                case (string)Engine::PHPTIMESERIES :
                    require "Ext_Modules/feed/engine/PHPTimeSeries.php";    // Variable interval no averaging
                    $engines[$e] = new PHPTimeSeries($this->settings['phptimeseries']);
                    break;
                case (string)Engine::MYSQLMEMORY : 
                    require_once "Ext_Modules/feed/engine/MysqlTimeSeries.php";  // Mysql engine
                    require "Ext_Modules/feed/engine/MysqlMemory.php";           // Mysql Memory engine
                    $engines[$e] = new MysqlMemory($this->mysqli);
                    break;
                case (string)Engine::CASSANDRA :
                    require "Ext_Modules/feed/engine/CassandraEngine.php";  // Cassandra engine
                ...
                default :
                    ...
                    require "Ext_Modules/feed/engine/TemplateEngine.php";
    ...
    */ 
    ...
    {
        require_once "Ext_Modules/feed/engine/shared_helper.php";
