...
<script type="text/javascript" src="<?php echo $path; ?>Libraries/tablejs/table.js"></script>
<script type="text/javascript" src="<?php echo $path; ?>Libraries/tablejs/custom-table-fields.js"></script>
