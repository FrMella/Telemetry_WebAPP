...
<script src="<?php echo $path; ?>Ext_Modules/device/Views/device.js?v=<?php echo $v; ?>"></script>
<?php } ?>

<script src="<?php echo $path; ?>Ext_Modules/input/Views/input.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo $path; ?>Ext_Modules/feed/feed.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo $path; ?>Libraries/responsive-linked-tables.js?v=<?php echo $v; ?>"></script>
...
<?php if ($device_module) require "Ext_Modules/device/Views/device_dialog.php"; ?>
<?php // delete and edit modals
    require "Ext_Modules/input/Views/input_dialog.php";
?>
<?php require "Ext_Modules/process/Views/process_ui.php"; ?>

<script src="<?php echo $path; ?>Libraries/moment.min.js"></script>

<script src="<?php echo $path; ?>Libraries/misc/gettext.js?v=<?php echo $v; ?>"></script>
...
<script src="<?php echo $path; ?>Ext_Modules/input/Views/input_view.js?v=<?php echo $v; ?>"></script>
