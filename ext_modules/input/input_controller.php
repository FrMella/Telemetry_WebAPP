...
function input_controller()
{
    ...
    if (!$device) {
        if (file_exists("Ext_Modules/device/device_model.php")) {
            require_once "Ext_Modules/device/device_model.php";
            $device = new Device($mysqli,$redis);
        }
    }

    require_once "Ext_Modules/input/input_methods.php";
    ...
    if ($session["write"])
    {
        ...
        // -------------------------------------------------------------------------
            ...
            $route->format = "html";
            textdomain("messages");
            return view("Ext_Modules/input/Views/input_api.php", array());
        }    
        else if ($route->action == 'view') {
            $route->format = "html";
            textdomain("messages");
            $device_module = false;
            if (file_exists("Ext_Modules/device")) $device_module = true;
            return view("Ext_Modules/input/Views/input_view.php", array(
                'path' => $path,
